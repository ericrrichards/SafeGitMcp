...
Supported commands are `get_current_changeset`, `get_commit_by_sha <full-sha1>`, `get_file_at_commit <full-sha1> <repository-relative-path>`, `list_commits_since_sha <full-sha1>`, `list_commits_since_timestamp <timestamp>`, `help`, and `exit`. Interactive mode accepts standard timestamps plus common forms such as `2026-09-17-20:00` and `2026-09-17 20:00`.
